...
CREATE TABLE `AddressMaster` (
  ...
  `IsDefult` tinyint(4) DEFAULT '0',
  `IsActive` tinyint(4) DEFAULT '0',
  `CreatedBy` varchar(100) DEFAULT NULL,
  `CreatedDate` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_Customer_Address_idx` (`UserId`),
  CONSTRAINT `fk_Address_Customer` FOREIGN KEY (`UserId`) REFERENCES `Customers` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Address_Sellers` FOREIGN KEY (`UserId`) REFERENCES `Sellers` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Address_Store` FOREIGN KEY (`UserId`) REFERENCES `StoreMaster` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Customers` VALUES (6,'gourav20170808','gourav@db.com','gourav','Pal','9876543210','Male','2017-09-09 00:00:00',NULL,NULL,'Single',NULL,1,'admin@api.com','2017-08-08 00:00:00',NULL,'2017-08-08 00:00:00'),(7,'ajay20170808','ajay@firstcry.com','ajay','santra','9876543210','Male','2017-09-09 00:00:00',NULL,NULL,'Single',NULL,1,'admin@api.com','2017-08-08 00:00:00',NULL,'2017-08-08 00:00:00'),(8,'C0001','rahulm@gmail.com','abhi','Sharma','9876543210','Male',NULL,'15955412PF63417867',NULL,NULL,NULL,1,'abhi@gmail.com','2017-08-12 09:45:28','abhi@gmail.com','2017-08-12 09:45:28'),(9,'C0001','test@gmail.com','test','k','8568565236','Male',NULL,'',NULL,NULL,NULL,1,NULL,'2017-08-13 00:54:32',NULL,'2017-08-13 00:54:32');
...
INSERT INTO `CustomersLog` VALUES (1,'gourav20170808','gourav@db.com','gourav','Pal','9876543210','Male','2017-09-09 00:00:00',NULL,NULL,'Single',NULL,1,'admin@api.com','2017-08-08 00:00:00',NULL,'2017-08-08 00:00:00'),(2,'C0001','rahulm@gmail.com','abhi','Sharma','9876543210','Male',NULL,'15955412PF63417867',NULL,NULL,NULL,1,'abhi@gmail.com','2017-08-12 09:45:28','abhi@gmail.com','2017-08-12 09:45:28'),(3,'C0001','test@gmail.com','test','k','8568565236','Male',NULL,'',NULL,NULL,NULL,1,NULL,'2017-08-13 00:54:32',NULL,'2017-08-13 00:54:32');
...
BEGIN
			...
			INSERT INTO `EcommerceDB`.`AddressMaster`
					...
					`PhoneNo2`, `IsDefult`, `IsActive`, `CreatedBy`, `CreatedDate`)
			VALUES
					(_name, _userId, _userType, _line1, line2, line3, _landmark, _state, _city, _pincode, _country, _phone1, _phone2, 
					_isDefult, 1, _userId, CURRENT_TIMESTAMP());
...
-- Dump completed on 2017-08-16 22:30:38
